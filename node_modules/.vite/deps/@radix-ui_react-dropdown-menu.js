...
function createSlot2(ownerName) {
  ...
  const Slot22 = React9.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime8.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React9.isValidElement(newElement) ? React9.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Menu = (props) => {
  ...
  const isUsingKeyboardRef = React10.useRef(false);
  ...
  return (0, import_jsx_runtime9.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime9.jsx)(
    MenuProvider,
    {
      ...
      children: (0, import_jsx_runtime9.jsx)(
        ...
        {
          scope: __scopeMenu,
          onClose: React10.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React10.forwardRef(
  (props, forwardedRef) => {
...
var MenuContent = React10.forwardRef(
  (props, forwardedRef) => {
...
var MenuRootContentModal = React10.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
...
var MenuRootContentNonModal = React10.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  return (0, import_jsx_runtime9.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React10.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React10.useState(null);
    const contentRef = React10.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React10.useRef(0);
    const searchRef = React10.useRef("");
    const pointerGraceTimerRef = React10.useRef(0);
    const pointerGraceIntentRef = React10.useRef(null);
    const pointerDirRef = React10.useRef("right");
    const lastPointerXRef = React10.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React10.Fragment;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React10.useCallback((event) => {
    ...
    return (0, import_jsx_runtime9.jsx)(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React10.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: React10.useCallback(
          (event) => {
        ...
        onTriggerLeave: React10.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ...
        onPointerGraceIntentChange: React10.useCallback((intent) => {
...
var MenuGroup = React10.forwardRef(
  (props, forwardedRef) => {
...
var MenuLabel = React10.forwardRef(
  (props, forwardedRef) => {
...
var MenuItem = React10.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemImpl = React10.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textContent, setTextContent] = React10.useState("");
    React10.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
...
var MenuCheckboxItem = React10.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioGroup = React10.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioItem = React10.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React10.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = React10.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React10.forwardRef(
  (props, forwardedRef) => {
...
var MenuSubTrigger = React10.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const openTimerRef = React10.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React10.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React10.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React10.useEffect(() => {
...
var MenuSubContent = React10.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
...
var DropdownMenuGroup = React11.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuCheckboxItem = React11.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioGroup = React11.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioItem = React11.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItemIndicator = React11.forwardRef((props, forwardedRef) => {
...
var DropdownMenuArrow = React11.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuSubTrigger = React11.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubContent = React11.forwardRef((props, forwardedRef) => {
